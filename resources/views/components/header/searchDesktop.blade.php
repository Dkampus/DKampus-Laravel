...
<div id="search-results-desktop" class="bg-white shadow-lg rounded-xl border h-0 min-w-[80vw] invisible opacity-0 transition-all duration-300 absolute z-50 top-[3rem] sm:min-w-[58vw] md:top-[3rem]">
    
</div>
</div>
<div onclick="hideResultsDesktop()" id="overlay-results-desktop" class="fixed bg-black/20 invisible transition-all duration-300 opacity-0 w-screen h-screen z-40 left-0 top-0"></div>