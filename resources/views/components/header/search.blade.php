<div class="w-[65%] relative flex flex-col items-center mx-auto">
    {{-- Search Input --}}
...
<div id="search-results" class="bg-white shadow-lg rounded-xl border h-0 min-w-[56vw] max-w-[80vw] invisible opacity-0 transition-all duration-300 absolute z-50 top-[3rem] sm:min-w-[21vw] md:">
