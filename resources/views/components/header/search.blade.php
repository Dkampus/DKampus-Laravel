<div class="flex flex-col items-center mx-auto">
    {{-- Search Input --}}
    <div onclick class="border-2 relative bg-white z-[60] min-w-[100%]  h-10 flex flex-row justify-between items-center border-[#F9832A]/40 gap-2 px-2 rounded-md overflow-hidden focus:border-[#F9832A]">
        <button class="min-w-[1rem] max-w-[10%] h-full">
            <img src="serach.svg" alt="" class="w-full h-full">
        </button>
        <input onclick="showResults()" id="search-input" name="value" type="" class="w-full h-full self-start outline-none ring-0 border-none text-[#F9832A] placeholder:font-medium placeholder:text-[#F9832A]" placeholder="Cari Menu">
