...
<input id="verificationInput" oninput="validateNumbersOnly(this)" maxlength="6" type="text" class="text-center text-black tracking-wide font-bold text-5xl border-2 w-96 mx-auto border-t-0 border-x-0 border-b-orange-500 focus:border-x-0 focus:border-t-0 focus:border-b-2 focus:border-b-orange-500 focus:ring-0 mt-5">
