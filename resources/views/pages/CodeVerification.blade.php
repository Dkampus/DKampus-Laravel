...
<input type="text" class="border-2 w-96 mx-auto border-t-0 border-x-0 border-b-orange-500 focus:border-x-0 focus:border-t-0 focus:border-b-2 focus:border-b-orange-500 focus:ring-0 mt-10">
<div id="timer" class="flex flex-col items-center">
    <h1>mohon tunggu dalam <span>30 </span>detik untuk kirim ulang</h1>
</div>
</div>
@endsection