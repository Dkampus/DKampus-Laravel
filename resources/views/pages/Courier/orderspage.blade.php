                ...
                <div class="flex flex-col gap-2 border border-[#F9832A] p-2">
                    <div class="px-6 py-4">
                        <div class="font-bold text-xl mb-2 flex flex-row">
                            ...
                            <span class="mx-2 font-semibold text-l">{{ $order['nama_pengirim'] }}</span>
                        </div>
                        {{--detail order --}}
                        <div class="flex flex-col gap-2">
                            <div class="flex flex-row justify-between">
                                <span class="font-semibold text-l">Nama Penerima</span>
                                <span class="font-semibold text-l">{{ $order['nama_penerima'] }}</span>
                            </div>
                            <div class="flex flex-row justify-between">
                                <span class="font-semibold text-l">Alamat Pengirim</span>
                                <span class="font-semibold text-l">{{ $order['alamat_pengirim'] }}</span>
                            </div>
                            <div class="flex flex-row justify-between">
                                <span class="font-semibold text-l">Alamat Penerima</span>
                                <span class="font-semibold text-l">{{ $order['alamat_penerima'] }}</span>
                            </div>
                            <div class="flex flex-row justify-between">
                                <span class="font-semibold text-l">Ongkir</span>
                                <span class="font-semibold text-l">{{ $order['ongkir'] }}</span>
                            </div>
                            <div class="flex flex-row justify-between">
                                <span class="font-semibold text-l">Status Paket</span>
                                <span class="font-semibold text-l">{{ $order['status_paket'] }}</span>
                            </div>
                        </div>
                    </div>
