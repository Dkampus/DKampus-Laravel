...
@section('pesananContent')
   <div class="flex flex-col gap-5 items-center justify-start bg-[#F0F3F8]">
    <section id="warung-ayam-baghdad" class="bg-white w-full flex flex-col items-center py-10">
        <div id="contentStatus" class="w-full h-80 overflow-auto mx-auto py-5">
            <div id="Title" class="border-b-[3px] pb-5 mx-auto flex flex-row justify-between items-center px-4 w-[29.5rem]">
            ...
            <div id="Content" class="grid grid-cols-2 grid-rows-2 gap-5 my-5 place-items-center">
            ...
            <div id="lineButton" class="w-full flex flex-row justify-center">
                <button><img src="/ArrowTop.svg" alt=""></button>
            </div>
            {{-- <button class="fixed w-full flex flex-col items-center bg-[#FF6E00] py-3">
                <svg height="7" viewBox="0 0 11 7" fill="none" xmlns="http://www.w3.org/2000/svg">
