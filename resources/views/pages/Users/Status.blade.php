           ...
           <section id="{{ str_replace(' ', '-', strtolower($cart['store_name'])) }}" class="bg-white w-full flex flex-col shadow-md justify-center items-center">
               ...
               <div class="flex flex-row justify-between w-[29.5rem] px-5 py-1">
                   ...
                   <div id="LacakAndChat" class="flex flex-row items-center gap-5">
                       <button class="bg-[#F9832A] w-20 h-9 flex flex-col items-center justify-center rounded-xl text-white">Lacak</button>
                       <button class="w-6"><img src="/bubbleChat.svg" alt="" class="w-full"></button>
                   </div>
               </div>
           </section>
    @endforeach
@endsection
{{--        <div class="bg-[#D4D4D4]/50 w-[29.5rem] h-[3px] my-4"></div>--}}
