...
<div class="flex flex-col gap-5 items-center justify-start bg-[#F0F3F8]">
    ...
    <section class="bg-white w-full flex flex-col shadow-md justify-center items-center">
        <form id="card" action="" method="POST">
            @csrf
            <input type="text" class="hidden" name="courId" id="courId">
        </form>
    </section>
</div>
@endsection
