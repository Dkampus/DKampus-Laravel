        ...
        <div id="cardList" class="flex flex-col transition-all duration-300 items-start gap-y-7 mt-10">
            ...
            <div id="cardPesanan" class="flex flex-row items-center justify-start gap-4 rounded-xl">
                ...
                <div id="favoriteAndCheckbox" class="flex flex-col gap-3 items-start mb-auto">
                    ...
                    <div id="like">
                        <label for="CardPesananCheckbox" id="CardPesananLikeButton" class="w-8 h-8 bg-white flex flex-col justify-center items-center border-2 border-[#5e5e5e]/40 rounded-md">
                            <svg id="CardPesananLikeIcon" height="20" class="fill-[#5e5e5e]/60 transition-all duration-300" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <input class="invisible absolute" type="checkbox" name="" id="CardPesananCheckbox">
                    </div>
                </div>
                    ...
                    <div for="checkboxMakanan" class="flex flex-row items-center">
                        ...
                        <div id="desc" class="flex flex-row justify-between w-full">
                            ...
                            <div id="count" class="flex flex-col items-center bg-white shadow-lg justify-between mr-2 my-auto rounded-lg w-[2.5rem] h-full">
                                ...
                                <input id="number" type="number" class="font-semibold bg-transparent w-[2.5rem] border-none text-center focus:border-none focus:ring-0" value="1" readonly/>
                                ...
                                <button onclick="DeleteItem()" id="delete" class="delete transition-all duration-300 bg-[#FF8080] rounded-xl scale-100 shadow-md flex w-[2.5rem] flex-col justify-center items-center h-[2.5rem] font-bold">
                                    <svg height="23" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.36136 12.1029C1.36136 12.4932 1.52167 12.8675 1.80702 13.1435C2.09236 13.4195 2.47938 13.5745 2.88292 13.5745H8.96914C9.37269 13.5745 9.7597 13.4195 10.045 13.1435C10.3304 12.8675 10.4907 12.4932 10.4907 12.1029V3.2731H1.36136V12.1029ZM2.88292 4.74473H8.96914V12.1029H2.88292V4.74473ZM8.58876 1.06565L7.82798 0.329834H4.02409L3.26331 1.06565H0.600586V2.53728H11.2515V1.06565H8.58876Z" fill="#EEEEEE"/></svg>                          
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            <div id="cardPesanan01" class="flex flex-row items-center justify-start gap-4 rounded-xl">
                {{-- Favorite and Checkbox --}}
                <div id="favoriteAndCheckbox" class="flex flex-col gap-3 items-start mb-auto">
                    <input type="checkbox" name="" id="checkboxMakanan" class="text-[#F9832A] border-2 rounded-md border-[#F9832A] w-8 h-8 transition-all duration-300 checked:fill-[#F9832A] checked:border-[#F9832A] checked:ring-[#F9832A] focus:fill-[#F9832A] focus:border-[#F9832A] focus:ring-[#F9832A]">
                    <div id="like">
                    ...
                    <div for="checkboxMakanan" class="flex flex-row items-center">
                        ...
                        <div id="desc" class="flex flex-row justify-between w-full">
                            ...
                            <div id="count" class="flex flex-col items-center bg-white shadow-lg justify-between mr-2 my-auto rounded-lg w-[2.5rem] h-full">
                                ...
                                <button onclick="DeleteItem2()" id="delete" class="delete transition-all duration-300 bg-[#FF8080] rounded-xl scale-100 shadow-md flex w-[2.5rem] flex-col justify-center items-center h-[2.5rem] font-bold">
                                    <svg height="23" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.36136 12.1029C1.36136 12.4932 1.52167 12.8675 1.80702 13.1435C2.09236 13.4195 2.47938 13.5745 2.88292 13.5745H8.96914C9.37269 13.5745 9.7597 13.4195 10.045 13.1435C10.3304 12.8675 10.4907 12.4932 10.4907 12.1029V3.2731H1.36136V12.1029ZM2.88292 4.74473H8.96914V12.1029H2.88292V4.74473ZM8.58876 1.06565L7.82798 0.329834H4.02409L3.26331 1.06565H0.600586V2.53728H11.2515V1.06565H8.58876Z" fill="#EEEEEE"/></svg>                          
                                </button>
                            </div>
                        </div>
