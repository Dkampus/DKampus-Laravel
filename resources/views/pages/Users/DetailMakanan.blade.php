...
<header class="relative">
    ...
    <nav id="navbar-detail-makanan" class="fixed transition-all duration-200 z-[60] py-3.5 w-full flex flex-row justify-between items-center px-6 mt-10 mb-5">
        ...
        {{-- Kembali --}}
        <a href="/detail-warung/{{$umkm_nama}}" class="font-semibold text-2xl h-12 w-12 bg-white flex flex-col justify-center items-center rounded-full">
        ...
        <label for="NavCheckbox" id="NavLikeButton" class="w-12 h-12 bg-white flex flex-col justify-center items-center rounded-full">
            <svg id="NavLikeIcon" height="25" class="fill-[#5e5e5e] transition-all duration-300" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div id="desc" class="absolute z-50 bottom-0 text-white px-5 flex flex-col gap-3.5 py-5">
            ...
            <div class="flex flex-row items-center justify-between gap-8">
                ...
                <div id="Ratings" class="flex flex-row text-lg items-center gap-2">
                    ...
                    {{-- <h3 id="countRatings">560 Ulasan</h3>--}}
                </div>
                {{-- Time --}}
...
<main>
    ...
    <form action="{{ url('/detail-makanan/' . $menu_id) }}" method="post">
        ...
        <div class="mx-5 my-7 flex flex-col gap-2">
            ...
            <div id="count" class="flex flex-row items-center bg-black/10 justify-around px-1 border-2 rounded-lg h-12 w-full">
                <button type="button" id="decrement" class="text-3xl flex flex-col justify-center h-full font-bold text-gray-500">-</button>
                <input id="number" name="quantity" type="number" class="font-semibold bg-transparent w-10 border-none text-center focus:border-none focus:ring-0 w-28" value="1" readonly />
    ...
    {{-- </svg>--}}
    {{-- </label>--}}
    {{-- <input type="checkbox" id="CardCheckbox" class="form-checkbox opacity-0" />--}}
    {{-- </div>--}}
    {{-- </div>--}}
    {{-- </div>--}}
    {{-- </div>--}}
